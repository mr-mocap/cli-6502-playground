...
protected:
    ...
    ftxui::Component  _accumulator_input;
    ftxui::Component  _x_input;
    ftxui::Component  _y_input;
    ftxui::Component  _stack_pointer_input;
    ftxui::Component  _program_counter_input;
    ftxui::Component  _status_input;
